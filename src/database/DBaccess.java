...
public class DBaccess {
    ...
    private static final String DATABASE_NAME = "Pensioen";
    private static final String MAIN_USER = "userPensioen";
    private static final String MAIN_USER_PASSWORD = "pwUserPensioen";
